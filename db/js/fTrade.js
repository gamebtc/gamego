...
const f = function (args) {
    ...
    try {
        ...
        const v1 = db.userLocker.insertOne({ _id: userId, agentId, recordId, init: now, up: now });
        if (v1.acknowledged === true) {
            ...
            //更新相同的键
            const r2 = db.userLocker.updateOne({ _id: userId, agentId }, { $set: { recordId, init: now, up: now } });
