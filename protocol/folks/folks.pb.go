...
func (*Player) Descriptor() ([]byte, []int) {
	return fileDescriptor_folks_aba1fc0ee7dd5d84, []int{0}
}
...
func (*UserLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_folks_aba1fc0ee7dd5d84, []int{1}
}
...
func (*GameBill) Descriptor() ([]byte, []int) {
	return fileDescriptor_folks_aba1fc0ee7dd5d84, []int{2}
}
...
type GameRound struct {
	...
	// 所有玩家投注分组
	AllBet []int64 `protobuf:"varint,8,rep,packed,name=allBet,proto3" json:"a" bson:"a" msg:"a"`
	// 发牌情况
...
func (*GameRound) Descriptor() ([]byte, []int) {
	return fileDescriptor_folks_aba1fc0ee7dd5d84, []int{3}
}
...
func (m *GameRound) GetAllBet() []int64 {
	if m != nil {
		return m.AllBet
	}
	return nil
...
func (*GameInitAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_folks_aba1fc0ee7dd5d84, []int{4}
}
...
func (*BetReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_folks_aba1fc0ee7dd5d84, []int{5}
}
...
func (*BetAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_folks_aba1fc0ee7dd5d84, []int{6}
}
...
func (*UserBetAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_folks_aba1fc0ee7dd5d84, []int{7}
}
...
func (*OpenBetAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_folks_aba1fc0ee7dd5d84, []int{8}
}
...
func (*CloseBetAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_folks_aba1fc0ee7dd5d84, []int{9}
}
...
func (*GameResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_folks_aba1fc0ee7dd5d84, []int{10}
}
...
func (m *GameRound) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.AllBet) > 0 {
		dAtA8 := make([]byte, len(m.AllBet)*10)
		var j7 int
		for _, num1 := range m.AllBet {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *GameResult) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Rich) > 0 {
		dAtA30 := make([]byte, len(m.Rich)*10)
		var j29 int
		for _, num1 := range m.Rich {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		dAtA[i] = 0x32
		i++
		i = encodeVarintFolks(dAtA, i, uint64(j29))
	...
	for iNdEx < l {
		...
		case 8:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.AllBet) == 0 {
					m.AllBet = make([]int64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int64
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field AllBet", wireType)
			}
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Poker", wireType)
...
func init() { proto.RegisterFile("folks.proto", fileDescriptor_folks_aba1fc0ee7dd5d84) }

var fileDescriptor_folks_aba1fc0ee7dd5d84 = []byte{
	...
	,
}
