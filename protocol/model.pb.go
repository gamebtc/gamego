...
func (c *gameClient) Send(ctx context.Context, opts ...grpc.CallOption) (Game_SendClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Game_serviceDesc.Streams[0], "/protocol.Game/Send", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *gameClient) Call(ctx context.Context, in *GameFrame, opts ...grpc.CallOption) (*GameFrame, error) {
	out := new(GameFrame)
	err := c.cc.Invoke(ctx, "/protocol.Game/Call", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
