...
func (MsgId_Code) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_msg_id_50e594f8da5bd0c3, []int{0, 0}
}
...
func (Error_Code) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_msg_id_50e594f8da5bd0c3, []int{1, 0}
}
...
func (*MsgId) Descriptor() ([]byte, []int) {
	return fileDescriptor_msg_id_50e594f8da5bd0c3, []int{0}
}
...
func (*Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_msg_id_50e594f8da5bd0c3, []int{1}
}
...
func init() { proto.RegisterFile("msg_id.proto", fileDescriptor_msg_id_50e594f8da5bd0c3) }

var fileDescriptor_msg_id_50e594f8da5bd0c3 = []byte{
	// 846 bytes of a gzipped FileDescriptorProto
	,
}
