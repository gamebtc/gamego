...
$root.protocol = (function() {
    ...
    protocol.Handshake = (function() {
         ...
         * @property {number|null} [code] Handshake code
         * @property {number|null} [seed] Handshake seed
         * @property {string|null} [msg] Handshake msg
         * @property {Array.<string>|null} [ip] Handshake ip
         */
         ...
         * @constructor
         * @param {protocol.IHandshake=} [properties] Properties to set
         */
         ...
         * Handshake code.
         * @member {number} code
         * @memberof protocol.Handshake
         * @instance
         */
        Handshake.prototype.code = 0;
         ...
         * @instance
         */
        Handshake.prototype.ip = $util.emptyArray;
         ...
         * @static
         * @param {protocol.IHandshake=} [properties] Properties to set
         * @returns {protocol.Handshake} Handshake instance
         */
        ...
        /**
         * Encodes the specified Handshake message. Does not implicitly {@link protocol.Handshake.verify|verify} messages.
         * @function encode
         * @memberof protocol.Handshake
         * @static
         * @param {protocol.IHandshake} message Handshake message or plain object to encode
        ...
        Handshake.encode = function encode(message, writer) {
            ...
            if (message.seed != null && message.hasOwnProperty("seed"))
                writer.uint32(/* id 2, wireType 0 =*/16).int32(message.seed);
            ...
            if (message.ip != null && message.ip.length)
                for (var i = 0; i < message.ip.length; ++i)
                    writer.uint32(/* id 4, wireType 2 =*/34).string(message.ip[i]);
            return writer;
        };

        /**
         * Encodes the specified Handshake message, length delimited. Does not implicitly {@link protocol.Handshake.verify|verify} messages.
         ...
         * @returns {protocol.Handshake} Handshake
        ...
        Handshake.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.Handshake();
        ...
        Handshake.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.Handshake)
                return object;
            var message = new $root.protocol.Handshake();
            if (object.code != null)
            ...
            if (object.ip) {
                if (!Array.isArray(object.ip))
                    throw TypeError(".protocol.Handshake.ip: array expected");
                message.ip = [];
         ...
         * @memberof protocol.Handshake
         * @static
         * @param {protocol.Handshake} message Handshake
    ...
    protocol.HeartBeatAck = (function() {

        /**
         * Properties of a HeartBeatAck.
         * @memberof protocol
         * @interface IHeartBeatAck
         * @property {number|null} [id] HeartBeatAck id
         */
         ...
         * @constructor
         * @param {protocol.IHeartBeatAck=} [properties] Properties to set
         */
         ...
         * HeartBeatAck id.
         * @member {number} id
         * @memberof protocol.HeartBeatAck
         * @instance
         */
        HeartBeatAck.prototype.id = 0;
         ...
         * @static
         * @param {protocol.IHeartBeatAck=} [properties] Properties to set
         * @returns {protocol.HeartBeatAck} HeartBeatAck instance
         */
        ...
        /**
         * Encodes the specified HeartBeatAck message. Does not implicitly {@link protocol.HeartBeatAck.verify|verify} messages.
         * @function encode
         * @memberof protocol.HeartBeatAck
         * @static
         * @param {protocol.IHeartBeatAck} message HeartBeatAck message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified HeartBeatAck message, length delimited. Does not implicitly {@link protocol.HeartBeatAck.verify|verify} messages.
         * @function encodeDelimited
         * @memberof protocol.HeartBeatAck
         * @static
         * @param {protocol.IHeartBeatAck} message HeartBeatAck message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {protocol.HeartBeatAck} HeartBeatAck
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        HeartBeatAck.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.HeartBeatAck();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        HeartBeatAck.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.HeartBeatAck)
                return object;
            var message = new $root.protocol.HeartBeatAck();
            if (object.id != null)
                message.id = object.id | 0;
            return message;
        };
         ...
         * @memberof protocol.HeartBeatAck
         * @static
         * @param {protocol.HeartBeatAck} message HeartBeatAck
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
    ...
    protocol.ErrorInfo = (function() {

        /**
         * Properties of an ErrorInfo.
         * @memberof protocol
         * @interface IErrorInfo
         * @property {number|null} [reqId] ErrorInfo reqId
         * @property {number|null} [code] ErrorInfo code
         * @property {string|null} [msg] ErrorInfo msg
         * @property {string|null} [key] ErrorInfo key
         */
         ...
         * @constructor
         * @param {protocol.IErrorInfo=} [properties] Properties to set
         */
         ...
         * ErrorInfo reqId.
         * @member {number} reqId
         * @memberof protocol.ErrorInfo
         * @instance
         */
        ErrorInfo.prototype.reqId = 0;
         ...
         * @static
         * @param {protocol.IErrorInfo=} [properties] Properties to set
         * @returns {protocol.ErrorInfo} ErrorInfo instance
         */
        ...
        /**
         * Encodes the specified ErrorInfo message. Does not implicitly {@link protocol.ErrorInfo.verify|verify} messages.
         * @function encode
         * @memberof protocol.ErrorInfo
         * @static
         * @param {protocol.IErrorInfo} message ErrorInfo message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified ErrorInfo message, length delimited. Does not implicitly {@link protocol.ErrorInfo.verify|verify} messages.
         * @function encodeDelimited
         * @memberof protocol.ErrorInfo
         * @static
         * @param {protocol.IErrorInfo} message ErrorInfo message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {protocol.ErrorInfo} ErrorInfo
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ErrorInfo.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.ErrorInfo();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        ErrorInfo.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.ErrorInfo)
                return object;
            var message = new $root.protocol.ErrorInfo();
         ...
         * @memberof protocol.ErrorInfo
         * @static
         * @param {protocol.ErrorInfo} message ErrorInfo
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
    ...
    protocol.FatalInfo = (function() {

        /**
         * Properties of a FatalInfo.
         * @memberof protocol
         * @interface IFatalInfo
         * @property {number|null} [reqId] FatalInfo reqId
         * @property {number|null} [code] FatalInfo code
         * @property {string|null} [msg] FatalInfo msg
         * @property {string|null} [key] FatalInfo key
         */

        /**
         * Constructs a new FatalInfo.
         * @memberof protocol
         * @classdesc Represents a FatalInfo.
         * @implements IFatalInfo
         * @constructor
         * @param {protocol.IFatalInfo=} [properties] Properties to set
         */
        function FatalInfo(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * FatalInfo reqId.
         * @member {number} reqId
         * @memberof protocol.FatalInfo
         * @instance
         */
        FatalInfo.prototype.reqId = 0;
         ...
         * @instance
         */
        FatalInfo.prototype.key = "";

        /**
         * Creates a new FatalInfo instance using the specified properties.
         * @function create
         * @memberof protocol.FatalInfo
         * @static
         * @param {protocol.IFatalInfo=} [properties] Properties to set
         * @returns {protocol.FatalInfo} FatalInfo instance
         */
        FatalInfo.create = function create(properties) {
            return new FatalInfo(properties);
        };

        /**
         * Encodes the specified FatalInfo message. Does not implicitly {@link protocol.FatalInfo.verify|verify} messages.
         * @function encode
         * @memberof protocol.FatalInfo
         * @static
         * @param {protocol.IFatalInfo} message FatalInfo message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        FatalInfo.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.reqId != null && message.hasOwnProperty("reqId"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.reqId);
        ...
        /**
         * Encodes the specified FatalInfo message, length delimited. Does not implicitly {@link protocol.FatalInfo.verify|verify} messages.
         * @function encodeDelimited
         * @memberof protocol.FatalInfo
         * @static
         * @param {protocol.IFatalInfo} message FatalInfo message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        FatalInfo.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a FatalInfo message from the specified reader or buffer.
         * @function decode
         * @memberof protocol.FatalInfo
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {protocol.FatalInfo} FatalInfo
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        FatalInfo.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.FatalInfo();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a FatalInfo message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof protocol.FatalInfo
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        FatalInfo.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        FatalInfo.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.reqId != null && message.hasOwnProperty("reqId"))
                if (!$util.isInteger(message.reqId))
        ...
        /**
         * Creates a FatalInfo message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof protocol.FatalInfo
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {protocol.FatalInfo} FatalInfo
         */
        FatalInfo.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.FatalInfo)
                return object;
            var message = new $root.protocol.FatalInfo();
            if (object.reqId != null)
                message.reqId = object.reqId | 0;
            if (object.code != null)
                message.code = object.code | 0;
        ...
        /**
         * Creates a plain object from a FatalInfo message. Also converts values to other types if specified.
         * @function toObject
         * @memberof protocol.FatalInfo
         * @static
         * @param {protocol.FatalInfo} message FatalInfo
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        FatalInfo.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
        ...
        /**
         * Converts this FatalInfo to JSON.
         * @function toJSON
         * @memberof protocol.FatalInfo
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        FatalInfo.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    protocol.DeviceInfo = (function() {
         ...
         * @property {string|null} [vend] DeviceInfo vend
         * @property {string|null} [name] DeviceInfo name
         * @property {string|null} [mac] DeviceInfo mac
         * @property {string|null} [imei] DeviceInfo imei
         * @property {string|null} [emid] DeviceInfo emid
         * @property {string|null} [sn] DeviceInfo sn
         * @property {string|null} [osLang] DeviceInfo osLang
         * @property {string|null} [osVer] DeviceInfo osVer
         * @property {string|null} [other] DeviceInfo other
         */
         ...
         * @constructor
         * @param {protocol.IDeviceInfo=} [properties] Properties to set
         */
        ...
        /**
         * DeviceInfo osLang.
         * @member {string} osLang
         * @memberof protocol.DeviceInfo
         * @instance
         */
        DeviceInfo.prototype.osLang = "";
         ...
         * @static
         * @param {protocol.IDeviceInfo=} [properties] Properties to set
         * @returns {protocol.DeviceInfo} DeviceInfo instance
         */
        ...
        /**
         * Encodes the specified DeviceInfo message. Does not implicitly {@link protocol.DeviceInfo.verify|verify} messages.
         * @function encode
         * @memberof protocol.DeviceInfo
         * @static
         * @param {protocol.IDeviceInfo} message DeviceInfo message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        DeviceInfo.encode = function encode(message, writer) {
            ...
            if (message.vend != null && message.hasOwnProperty("vend"))
                writer.uint32(/* id 2, wireType 2 =*/18).string(message.vend);
            ...
            if (message.imei != null && message.hasOwnProperty("imei"))
                writer.uint32(/* id 5, wireType 2 =*/42).string(message.imei);
            if (message.emid != null && message.hasOwnProperty("emid"))
                writer.uint32(/* id 6, wireType 2 =*/50).string(message.emid);
            if (message.sn != null && message.hasOwnProperty("sn"))
                writer.uint32(/* id 7, wireType 2 =*/58).string(message.sn);
            if (message.osLang != null && message.hasOwnProperty("osLang"))
                writer.uint32(/* id 8, wireType 2 =*/66).string(message.osLang);
            if (message.osVer != null && message.hasOwnProperty("osVer"))
                writer.uint32(/* id 9, wireType 2 =*/74).string(message.osVer);
            if (message.other != null && message.hasOwnProperty("other"))
                writer.uint32(/* id 10, wireType 2 =*/82).string(message.other);
            return writer;
        };

        /**
         * Encodes the specified DeviceInfo message, length delimited. Does not implicitly {@link protocol.DeviceInfo.verify|verify} messages.
         * @function encodeDelimited
         * @memberof protocol.DeviceInfo
         * @static
         * @param {protocol.IDeviceInfo} message DeviceInfo message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {protocol.DeviceInfo} DeviceInfo
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        DeviceInfo.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.DeviceInfo();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                ...
                case 5:
                    ...
                    break;
                case 6:
                    message.emid = reader.string();
                    break;
                case 7:
                    message.sn = reader.string();
                    break;
                case 8:
                    message.osLang = reader.string();
                    break;
                case 9:
        ...
        DeviceInfo.verify = function verify(message) {
            ...
            if (message.vend != null && message.hasOwnProperty("vend"))
                if (!$util.isString(message.vend))
                    return "vend: string expected";
            if (message.name != null && message.hasOwnProperty("name"))
            ...
            if (message.emid != null && message.hasOwnProperty("emid"))
                if (!$util.isString(message.emid))
                    return "emid: string expected";
            if (message.sn != null && message.hasOwnProperty("sn"))
                if (!$util.isString(message.sn))
                    return "sn: string expected";
            if (message.osLang != null && message.hasOwnProperty("osLang"))
                if (!$util.isString(message.osLang))
                    return "osLang: string expected";
            if (message.osVer != null && message.hasOwnProperty("osVer"))
                if (!$util.isString(message.osVer))
                    return "osVer: string expected";
            if (message.other != null && message.hasOwnProperty("other"))
        ...
        DeviceInfo.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.DeviceInfo)
                return object;
            var message = new $root.protocol.DeviceInfo();
            if (object.id != null)
                message.id = String(object.id);
            if (object.vend != null)
                message.vend = String(object.vend);
            if (object.name != null)
            ...
            if (object.emid != null)
                message.emid = String(object.emid);
            if (object.sn != null)
                message.sn = String(object.sn);
            if (object.osLang != null)
                message.osLang = String(object.osLang);
            if (object.osVer != null)
                message.osVer = String(object.osVer);
         ...
         * @memberof protocol.DeviceInfo
         * @static
         * @param {protocol.DeviceInfo} message DeviceInfo
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        DeviceInfo.toObject = function toObject(message, options) {
            ...
            if (message.emid != null && message.hasOwnProperty("emid"))
                object.emid = message.emid;
            if (message.sn != null && message.hasOwnProperty("sn"))
                object.sn = message.sn;
            if (message.osLang != null && message.hasOwnProperty("osLang"))
                object.osLang = message.osLang;
            if (message.osVer != null && message.hasOwnProperty("osVer"))
                object.osVer = message.osVer;
            if (message.other != null && message.hasOwnProperty("other"))
    ...
    protocol.Envirnment = (function() {

        /**
         * Properties of an Envirnment.
         * @memberof protocol
         * @interface IEnvirnment
         * @property {number|null} [app] Envirnment app
         * @property {number|null} [pack] Envirnment pack
         * @property {string|null} [ver] Envirnment ver
         * @property {string|null} [chan] Envirnment chan
         * @property {string|null} [refer] Envirnment refer
         * @property {string|null} [other] Envirnment other
         */

        /**
         * Constructs a new Envirnment.
         * @memberof protocol
         * @classdesc Represents an Envirnment.
         * @implements IEnvirnment
         * @constructor
         * @param {protocol.IEnvirnment=} [properties] Properties to set
         */
        function Envirnment(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * Envirnment app.
         * @member {number} app
         * @memberof protocol.Envirnment
         * @instance
         */
        Envirnment.prototype.app = 0;
         ...
         * @instance
         */
        Envirnment.prototype.other = "";

        /**
         * Creates a new Envirnment instance using the specified properties.
         * @function create
         * @memberof protocol.Envirnment
         * @static
         * @param {protocol.IEnvirnment=} [properties] Properties to set
         * @returns {protocol.Envirnment} Envirnment instance
         */
        Envirnment.create = function create(properties) {
            return new Envirnment(properties);
        };

        /**
         * Encodes the specified Envirnment message. Does not implicitly {@link protocol.Envirnment.verify|verify} messages.
         * @function encode
         * @memberof protocol.Envirnment
         * @static
         * @param {protocol.IEnvirnment} message Envirnment message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        Envirnment.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            ...
            if (message.pack != null && message.hasOwnProperty("pack"))
                writer.uint32(/* id 2, wireType 0 =*/16).int32(message.pack);
            ...
            if (message.chan != null && message.hasOwnProperty("chan"))
                writer.uint32(/* id 4, wireType 2 =*/34).string(message.chan);
            if (message.refer != null && message.hasOwnProperty("refer"))
                writer.uint32(/* id 5, wireType 2 =*/42).string(message.refer);
            if (message.other != null && message.hasOwnProperty("other"))
                writer.uint32(/* id 6, wireType 2 =*/50).string(message.other);
            return writer;
        };

        /**
         * Encodes the specified Envirnment message, length delimited. Does not implicitly {@link protocol.Envirnment.verify|verify} messages.
         * @function encodeDelimited
         * @memberof protocol.Envirnment
         * @static
         * @param {protocol.IEnvirnment} message Envirnment message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        Envirnment.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes an Envirnment message from the specified reader or buffer.
         * @function decode
         * @memberof protocol.Envirnment
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {protocol.Envirnment} Envirnment
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Envirnment.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.Envirnment();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.chan = reader.string();
                    break;
                case 5:
                    message.refer = reader.string();
                    break;
                case 6:
                    message.other = reader.string();
                    break;
        ...
        /**
         * Decodes an Envirnment message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof protocol.Envirnment
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Envirnment.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies an Envirnment message.
         * @function verify
         * @memberof protocol.Envirnment
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        Envirnment.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.app != null && message.hasOwnProperty("app"))
            ...
            if (message.pack != null && message.hasOwnProperty("pack"))
                if (!$util.isInteger(message.pack))
                    return "pack: integer expected";
            if (message.ver != null && message.hasOwnProperty("ver"))
                if (!$util.isString(message.ver))
                    return "ver: string expected";
            if (message.chan != null && message.hasOwnProperty("chan"))
                if (!$util.isString(message.chan))
                    return "chan: string expected";
            if (message.refer != null && message.hasOwnProperty("refer"))
                if (!$util.isString(message.refer))
                    return "refer: string expected";
            if (message.other != null && message.hasOwnProperty("other"))
                if (!$util.isString(message.other))
                    return "other: string expected";
            return null;
        ...
        /**
         * Creates an Envirnment message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof protocol.Envirnment
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {protocol.Envirnment} Envirnment
         */
        Envirnment.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.Envirnment)
                return object;
            var message = new $root.protocol.Envirnment();
            if (object.app != null)
            ...
            if (object.chan != null)
                message.chan = String(object.chan);
            if (object.refer != null)
                message.refer = String(object.refer);
            if (object.other != null)
                message.other = String(object.other);
            return message;
        };
        ...
        /**
         * Creates a plain object from an Envirnment message. Also converts values to other types if specified.
         * @function toObject
         * @memberof protocol.Envirnment
         * @static
         * @param {protocol.Envirnment} message Envirnment
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        Envirnment.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
        ...
        /**
         * Converts this Envirnment to JSON.
         * @function toJSON
         * @memberof protocol.Envirnment
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        Envirnment.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    protocol.VerCheckReq = (function() {

        /**
         * Properties of a VerCheckReq.
         * @memberof protocol
         * @interface IVerCheckReq
         * @property {protocol.IEnvirnment|null} [env] VerCheckReq env
         * @property {number|null} [time] VerCheckReq time
         * @property {number|null} [check] VerCheckReq check
         */

        /**
         * Constructs a new VerCheckReq.
         * @memberof protocol
         * @classdesc Represents a VerCheckReq.
         * @implements IVerCheckReq
         * @constructor
         * @param {protocol.IVerCheckReq=} [properties] Properties to set
         */
        function VerCheckReq(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * VerCheckReq env.
         * @member {protocol.IEnvirnment|null|undefined} env
         * @memberof protocol.VerCheckReq
         * @instance
         */
        VerCheckReq.prototype.env = null;
         ...
         * @instance
         */
        VerCheckReq.prototype.check = 0;

        /**
         * Creates a new VerCheckReq instance using the specified properties.
         * @function create
         * @memberof protocol.VerCheckReq
         * @static
         * @param {protocol.IVerCheckReq=} [properties] Properties to set
         * @returns {protocol.VerCheckReq} VerCheckReq instance
         */
        VerCheckReq.create = function create(properties) {
            return new VerCheckReq(properties);
        };

        /**
         * Encodes the specified VerCheckReq message. Does not implicitly {@link protocol.VerCheckReq.verify|verify} messages.
         * @function encode
         * @memberof protocol.VerCheckReq
         * @static
         * @param {protocol.IVerCheckReq} message VerCheckReq message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        VerCheckReq.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.env != null && message.hasOwnProperty("env"))
                $root.protocol.Envirnment.encode(message.env, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.time != null && message.hasOwnProperty("time"))
                writer.uint32(/* id 2, wireType 0 =*/16).int32(message.time);
            if (message.check != null && message.hasOwnProperty("check"))
                writer.uint32(/* id 3, wireType 0 =*/24).int32(message.check);
            return writer;
        };

        /**
         * Encodes the specified VerCheckReq message, length delimited. Does not implicitly {@link protocol.VerCheckReq.verify|verify} messages.
         * @function encodeDelimited
         * @memberof protocol.VerCheckReq
         * @static
         * @param {protocol.IVerCheckReq} message VerCheckReq message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        VerCheckReq.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a VerCheckReq message from the specified reader or buffer.
         * @function decode
         * @memberof protocol.VerCheckReq
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {protocol.VerCheckReq} VerCheckReq
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        VerCheckReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.VerCheckReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    message.env = $root.protocol.Envirnment.decode(reader, reader.uint32());
                    break;
                case 2:
                    message.time = reader.int32();
                    break;
                case 3:
                    message.check = reader.int32();
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        /**
         * Decodes a VerCheckReq message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof protocol.VerCheckReq
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        VerCheckReq.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a VerCheckReq message.
         * @function verify
         * @memberof protocol.VerCheckReq
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        VerCheckReq.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.env != null && message.hasOwnProperty("env")) {
                var error = $root.protocol.Envirnment.verify(message.env);
                if (error)
                    return "env." + error;
            }
            if (message.time != null && message.hasOwnProperty("time"))
            ...
            if (message.check != null && message.hasOwnProperty("check"))
                if (!$util.isInteger(message.check))
                    return "check: integer expected";
            return null;
        };

        /**
         * Creates a VerCheckReq message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof protocol.VerCheckReq
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {protocol.VerCheckReq} VerCheckReq
         */
        VerCheckReq.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.VerCheckReq)
                return object;
            var message = new $root.protocol.VerCheckReq();
            if (object.env != null) {
                if (typeof object.env !== "object")
                    throw TypeError(".protocol.VerCheckReq.env: object expected");
                message.env = $root.protocol.Envirnment.fromObject(object.env);
            }
            if (object.time != null)
                message.time = object.time | 0;
            if (object.check != null)
                message.check = object.check | 0;
            return message;
        };

        /**
         * Creates a plain object from a VerCheckReq message. Also converts values to other types if specified.
         * @function toObject
         * @memberof protocol.VerCheckReq
         * @static
         * @param {protocol.VerCheckReq} message VerCheckReq
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        VerCheckReq.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
            ...
            if (message.env != null && message.hasOwnProperty("env"))
                object.env = $root.protocol.Envirnment.toObject(message.env, options);
            if (message.time != null && message.hasOwnProperty("time"))
        ...
        /**
         * Converts this VerCheckReq to JSON.
         * @function toJSON
         * @memberof protocol.VerCheckReq
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        VerCheckReq.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    protocol.VerCheckAck = (function() {

        /**
         * Properties of a VerCheckAck.
         * @memberof protocol
         * @interface IVerCheckAck
         * @property {number|null} [code] VerCheckAck code
         * @property {string|null} [msg] VerCheckAck msg
         * @property {number|null} [canReg] VerCheckAck canReg
         * @property {number|null} [canLogin] VerCheckAck canLogin
         * @property {string|null} [url] VerCheckAck url
         * @property {string|null} [country] VerCheckAck country
         * @property {string|null} [region] VerCheckAck region
         * @property {string|null} [city] VerCheckAck city
         * @property {Object.<string,string>|null} [conf] VerCheckAck conf
         */

        /**
         * Constructs a new VerCheckAck.
         * @memberof protocol
         * @classdesc Represents a VerCheckAck.
         * @implements IVerCheckAck
         * @constructor
         * @param {protocol.IVerCheckAck=} [properties] Properties to set
         */
        function VerCheckAck(properties) {
            this.conf = {};
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
         ...
         * VerCheckAck code.
         * @member {number} code
         * @memberof protocol.VerCheckAck
         * @instance
         */
        VerCheckAck.prototype.code = 0;
         ...
         * @instance
         */
        VerCheckAck.prototype.msg = "";

        /**
         * VerCheckAck canReg.
         * @member {number} canReg
         * @memberof protocol.VerCheckAck
         * @instance
         */
        VerCheckAck.prototype.canReg = 0;

        /**
         * VerCheckAck canLogin.
         * @member {number} canLogin
         * @memberof protocol.VerCheckAck
         * @instance
         */
        VerCheckAck.prototype.canLogin = 0;
         ...
         * @instance
         */
        VerCheckAck.prototype.city = "";

        /**
         * VerCheckAck conf.
         * @member {Object.<string,string>} conf
         * @memberof protocol.VerCheckAck
         * @instance
         */
        VerCheckAck.prototype.conf = $util.emptyObject;

        /**
         * Creates a new VerCheckAck instance using the specified properties.
         * @function create
         * @memberof protocol.VerCheckAck
         * @static
         * @param {protocol.IVerCheckAck=} [properties] Properties to set
         * @returns {protocol.VerCheckAck} VerCheckAck instance
         */
        VerCheckAck.create = function create(properties) {
            return new VerCheckAck(properties);
        };

        /**
         * Encodes the specified VerCheckAck message. Does not implicitly {@link protocol.VerCheckAck.verify|verify} messages.
         * @function encode
         * @memberof protocol.VerCheckAck
         * @static
         * @param {protocol.IVerCheckAck} message VerCheckAck message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        VerCheckAck.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.code != null && message.hasOwnProperty("code"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.code);
            ...
            if (message.canReg != null && message.hasOwnProperty("canReg"))
                writer.uint32(/* id 3, wireType 0 =*/24).int32(message.canReg);
            if (message.canLogin != null && message.hasOwnProperty("canLogin"))
                writer.uint32(/* id 4, wireType 0 =*/32).int32(message.canLogin);
            ...
            if (message.conf != null && message.hasOwnProperty("conf"))
                for (var keys = Object.keys(message.conf), i = 0; i < keys.length; ++i)
                    writer.uint32(/* id 9, wireType 2 =*/74).fork().uint32(/* id 1, wireType 2 =*/10).string(keys[i]).uint32(/* id 2, wireType 2 =*/18).string(message.conf[keys[i]]).ldelim();
            return writer;
        };

        /**
         * Encodes the specified VerCheckAck message, length delimited. Does not implicitly {@link protocol.VerCheckAck.verify|verify} messages.
         * @function encodeDelimited
         * @memberof protocol.VerCheckAck
         * @static
         * @param {protocol.IVerCheckAck} message VerCheckAck message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        VerCheckAck.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a VerCheckAck message from the specified reader or buffer.
         * @function decode
         * @memberof protocol.VerCheckAck
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {protocol.VerCheckAck} VerCheckAck
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        VerCheckAck.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.VerCheckAck(), key;
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.canReg = reader.int32();
                    break;
                case 4:
                    message.canLogin = reader.int32();
                    break;
                case 5:
                ...
                case 9:
                    reader.skip().pos++;
                    if (message.conf === $util.emptyObject)
                        message.conf = {};
                    key = reader.string();
                    reader.pos++;
                    message.conf[key] = reader.string();
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        /**
         * Decodes a VerCheckAck message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof protocol.VerCheckAck
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        VerCheckAck.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a VerCheckAck message.
         * @function verify
         * @memberof protocol.VerCheckAck
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        VerCheckAck.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.code != null && message.hasOwnProperty("code"))
                if (!$util.isInteger(message.code))
            ...
            if (message.msg != null && message.hasOwnProperty("msg"))
                if (!$util.isString(message.msg))
                    return "msg: string expected";
            if (message.canReg != null && message.hasOwnProperty("canReg"))
                if (!$util.isInteger(message.canReg))
                    return "canReg: integer expected";
            if (message.canLogin != null && message.hasOwnProperty("canLogin"))
                if (!$util.isInteger(message.canLogin))
                    return "canLogin: integer expected";
            if (message.url != null && message.hasOwnProperty("url"))
            ...
            if (message.conf != null && message.hasOwnProperty("conf")) {
                if (!$util.isObject(message.conf))
                    return "conf: object expected";
                var key = Object.keys(message.conf);
                for (var i = 0; i < key.length; ++i)
                    if (!$util.isString(message.conf[key[i]]))
                        return "conf: string{k:string} expected";
            }
            return null;
        };

        /**
         * Creates a VerCheckAck message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof protocol.VerCheckAck
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {protocol.VerCheckAck} VerCheckAck
         */
        VerCheckAck.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.VerCheckAck)
                return object;
            var message = new $root.protocol.VerCheckAck();
            if (object.code != null)
                message.code = object.code | 0;
            if (object.msg != null)
                message.msg = String(object.msg);
            if (object.canReg != null)
                message.canReg = object.canReg | 0;
            if (object.canLogin != null)
                message.canLogin = object.canLogin | 0;
            if (object.url != null)
            ...
            if (object.conf) {
                if (typeof object.conf !== "object")
                    throw TypeError(".protocol.VerCheckAck.conf: object expected");
                message.conf = {};
                for (var keys = Object.keys(object.conf), i = 0; i < keys.length; ++i)
                    message.conf[keys[i]] = String(object.conf[keys[i]]);
            }
            return message;
        };

        /**
         * Creates a plain object from a VerCheckAck message. Also converts values to other types if specified.
         * @function toObject
         * @memberof protocol.VerCheckAck
         * @static
         * @param {protocol.VerCheckAck} message VerCheckAck
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        VerCheckAck.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            ...
            if (message.msg != null && message.hasOwnProperty("msg"))
                object.msg = message.msg;
            if (message.canReg != null && message.hasOwnProperty("canReg"))
                object.canReg = message.canReg;
            if (message.canLogin != null && message.hasOwnProperty("canLogin"))
                object.canLogin = message.canLogin;
            if (message.url != null && message.hasOwnProperty("url"))
            ...
            var keys2;
            if (message.conf && (keys2 = Object.keys(message.conf)).length) {
                object.conf = {};
                for (var j = 0; j < keys2.length; ++j)
                    object.conf[keys2[j]] = message.conf[keys2[j]];
            }
            return object;
        };

        /**
         * Converts this VerCheckAck to JSON.
         * @function toJSON
         * @memberof protocol.VerCheckAck
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        VerCheckAck.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    protocol.LoginReq = (function() {
         ...
         * @property {string|null} [pwd] LoginReq pwd
         * @property {string|null} [udid] LoginReq udid
         * @property {number|null} [uid] LoginReq uid
         * @property {number|null} [time] LoginReq time
         * @property {protocol.IDeviceInfo|null} [dev] LoginReq dev
         * @property {protocol.IEnvirnment|null} [env] LoginReq env
         */
         ...
         * @instance
         */
        LoginReq.prototype.time = 0;

        /**
         * LoginReq dev.
         * @member {protocol.IDeviceInfo|null|undefined} dev
         * @memberof protocol.LoginReq
         * @instance
         */
        LoginReq.prototype.dev = null;
        ...
        LoginReq.encode = function encode(message, writer) {
            ...
            if (message.dev != null && message.hasOwnProperty("dev"))
                $root.protocol.DeviceInfo.encode(message.dev, writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
            if (message.env != null && message.hasOwnProperty("env"))
                $root.protocol.Envirnment.encode(message.env, writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
            return writer;
        };
        ...
        LoginReq.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    message.dev = $root.protocol.DeviceInfo.decode(reader, reader.uint32());
                    break;
                case 8:
                    message.env = $root.protocol.Envirnment.decode(reader, reader.uint32());
                    break;
        ...
        LoginReq.verify = function verify(message) {
            ...
            if (message.time != null && message.hasOwnProperty("time"))
                if (!$util.isInteger(message.time))
                    return "time: integer expected";
            if (message.dev != null && message.hasOwnProperty("dev")) {
                var error = $root.protocol.DeviceInfo.verify(message.dev);
                if (error)
                    return "dev." + error;
            }
            if (message.env != null && message.hasOwnProperty("env")) {
        ...
        LoginReq.fromObject = function fromObject(object) {
            ...
            if (object.dev != null) {
                if (typeof object.dev !== "object")
                    throw TypeError(".protocol.LoginReq.dev: object expected");
                message.dev = $root.protocol.DeviceInfo.fromObject(object.dev);
            }
            if (object.env != null) {
                if (typeof object.env !== "object")
                    throw TypeError(".protocol.LoginReq.env: object expected");
                message.env = $root.protocol.Envirnment.fromObject(object.env);
            }
            return message;
        };
        ...
        LoginReq.toObject = function toObject(message, options) {
            ...
            if (message.time != null && message.hasOwnProperty("time"))
                object.time = message.time;
            if (message.dev != null && message.hasOwnProperty("dev"))
                object.dev = $root.protocol.DeviceInfo.toObject(message.dev, options);
            if (message.env != null && message.hasOwnProperty("env"))
                object.env = $root.protocol.Envirnment.toObject(message.env, options);
            return object;
        };
    ...
    protocol.LoginSuccessAck = (function() {

        /**
         * Properties of a LoginSuccessAck.
         * @memberof protocol
         * @interface ILoginSuccessAck
         * @property {number|null} [id] LoginSuccessAck id
         * @property {number|null} [agent] LoginSuccessAck agent
         * @property {number|null} [icon] LoginSuccessAck icon
         * @property {number|null} [sex] LoginSuccessAck sex
         * @property {number|null} [vip] LoginSuccessAck vip
         * @property {string|null} [act] LoginSuccessAck act
         * @property {string|null} [name] LoginSuccessAck name
         * @property {string|null} [phone] LoginSuccessAck phone
         * @property {Object.<string,number>|null} [bag] LoginSuccessAck bag
         * @property {number|null} [game] LoginSuccessAck game
         * @property {number|null} [level] LoginSuccessAck level
         * @property {number|null} [room] LoginSuccessAck room
         */

        /**
         * Constructs a new LoginSuccessAck.
         * @memberof protocol
         * @classdesc Represents a LoginSuccessAck.
         * @implements ILoginSuccessAck
         * @constructor
         * @param {protocol.ILoginSuccessAck=} [properties] Properties to set
         */
        function LoginSuccessAck(properties) {
            this.bag = {};
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
         ...
         * LoginSuccessAck id.
         * @member {number} id
         * @memberof protocol.LoginSuccessAck
         * @instance
         */
        LoginSuccessAck.prototype.id = 0;

        /**
         * LoginSuccessAck agent.
         * @member {number} agent
         * @memberof protocol.LoginSuccessAck
         * @instance
         */
        LoginSuccessAck.prototype.agent = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * LoginSuccessAck icon.
         * @member {number} icon
         * @memberof protocol.LoginSuccessAck
         * @instance
         */
        LoginSuccessAck.prototype.icon = 0;
         ...
         * @instance
         */
        LoginSuccessAck.prototype.sex = 0;
         ...
         * @instance
         */
        LoginSuccessAck.prototype.vip = 0;
         ...
         * @instance
         */
        LoginSuccessAck.prototype.act = "";

        /**
         * LoginSuccessAck name.
         * @member {string} name
         * @memberof protocol.LoginSuccessAck
         * @instance
         */
        LoginSuccessAck.prototype.name = "";

        /**
         * LoginSuccessAck phone.
         * @member {string} phone
         * @memberof protocol.LoginSuccessAck
         * @instance
         */
        LoginSuccessAck.prototype.phone = "";

        /**
         * LoginSuccessAck bag.
         * @member {Object.<string,number>} bag
         * @memberof protocol.LoginSuccessAck
         * @instance
         */
        LoginSuccessAck.prototype.bag = $util.emptyObject;

        /**
         * LoginSuccessAck game.
         * @member {number} game
         * @memberof protocol.LoginSuccessAck
         * @instance
         */
        LoginSuccessAck.prototype.game = 0;

        /**
         * LoginSuccessAck level.
         * @member {number} level
         * @memberof protocol.LoginSuccessAck
         * @instance
         */
        LoginSuccessAck.prototype.level = 0;

        /**
         * LoginSuccessAck room.
         * @member {number} room
         * @memberof protocol.LoginSuccessAck
         * @instance
         */
        LoginSuccessAck.prototype.room = 0;

        /**
         * Creates a new LoginSuccessAck instance using the specified properties.
         * @function create
         * @memberof protocol.LoginSuccessAck
         * @static
         * @param {protocol.ILoginSuccessAck=} [properties] Properties to set
         * @returns {protocol.LoginSuccessAck} LoginSuccessAck instance
         */
        LoginSuccessAck.create = function create(properties) {
            return new LoginSuccessAck(properties);
        };

        /**
         * Encodes the specified LoginSuccessAck message. Does not implicitly {@link protocol.LoginSuccessAck.verify|verify} messages.
         * @function encode
         * @memberof protocol.LoginSuccessAck
         * @static
         * @param {protocol.ILoginSuccessAck} message LoginSuccessAck message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        LoginSuccessAck.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.id != null && message.hasOwnProperty("id"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.id);
            if (message.agent != null && message.hasOwnProperty("agent"))
                writer.uint32(/* id 2, wireType 0 =*/16).int64(message.agent);
            ...
            if (message.vip != null && message.hasOwnProperty("vip"))
                writer.uint32(/* id 5, wireType 0 =*/40).int32(message.vip);
            if (message.act != null && message.hasOwnProperty("act"))
                writer.uint32(/* id 6, wireType 2 =*/50).string(message.act);
            if (message.name != null && message.hasOwnProperty("name"))
            ...
            if (message.bag != null && message.hasOwnProperty("bag"))
                for (var keys = Object.keys(message.bag), i = 0; i < keys.length; ++i)
                    writer.uint32(/* id 9, wireType 2 =*/74).fork().uint32(/* id 1, wireType 2 =*/10).string(keys[i]).uint32(/* id 2, wireType 0 =*/16).int64(message.bag[keys[i]]).ldelim();
            if (message.game != null && message.hasOwnProperty("game"))
                writer.uint32(/* id 10, wireType 0 =*/80).int32(message.game);
            if (message.level != null && message.hasOwnProperty("level"))
                writer.uint32(/* id 11, wireType 0 =*/88).int32(message.level);
            if (message.room != null && message.hasOwnProperty("room"))
                writer.uint32(/* id 12, wireType 0 =*/96).int32(message.room);
            return writer;
        };

        /**
         * Encodes the specified LoginSuccessAck message, length delimited. Does not implicitly {@link protocol.LoginSuccessAck.verify|verify} messages.
         * @function encodeDelimited
         * @memberof protocol.LoginSuccessAck
         * @static
         * @param {protocol.ILoginSuccessAck} message LoginSuccessAck message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        LoginSuccessAck.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a LoginSuccessAck message from the specified reader or buffer.
         * @function decode
         * @memberof protocol.LoginSuccessAck
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {protocol.LoginSuccessAck} LoginSuccessAck
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        LoginSuccessAck.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.LoginSuccessAck(), key;
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a LoginSuccessAck message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof protocol.LoginSuccessAck
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        LoginSuccessAck.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a LoginSuccessAck message.
         * @function verify
         * @memberof protocol.LoginSuccessAck
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        LoginSuccessAck.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.id != null && message.hasOwnProperty("id"))
                if (!$util.isInteger(message.id))
                    return "id: integer expected";
            if (message.agent != null && message.hasOwnProperty("agent"))
                if (!$util.isInteger(message.agent) && !(message.agent && $util.isInteger(message.agent.low) && $util.isInteger(message.agent.high)))
                    return "agent: integer|Long expected";
            if (message.icon != null && message.hasOwnProperty("icon"))
            ...
            if (message.bag != null && message.hasOwnProperty("bag")) {
                ...
                for (var i = 0; i < key.length; ++i)
                    if (!$util.isInteger(message.bag[key[i]]) && !(message.bag[key[i]] && $util.isInteger(message.bag[key[i]].low) && $util.isInteger(message.bag[key[i]].high)))
                        return "bag: integer|Long{k:string} expected";
            }
            if (message.game != null && message.hasOwnProperty("game"))
        ...
        /**
         * Creates a LoginSuccessAck message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof protocol.LoginSuccessAck
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {protocol.LoginSuccessAck} LoginSuccessAck
         */
        LoginSuccessAck.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.LoginSuccessAck)
                return object;
            var message = new $root.protocol.LoginSuccessAck();
            if (object.id != null)
                message.id = object.id | 0;
            if (object.agent != null)
                if ($util.Long)
                    (message.agent = $util.Long.fromValue(object.agent)).unsigned = false;
                else if (typeof object.agent === "string")
                    message.agent = parseInt(object.agent, 10);
                else if (typeof object.agent === "number")
                    message.agent = object.agent;
                else if (typeof object.agent === "object")
                    message.agent = new $util.LongBits(object.agent.low >>> 0, object.agent.high >>> 0).toNumber();
            if (object.icon != null)
            ...
            if (object.bag) {
                if (typeof object.bag !== "object")
                    throw TypeError(".protocol.LoginSuccessAck.bag: object expected");
                message.bag = {};
                for (var keys = Object.keys(object.bag), i = 0; i < keys.length; ++i)
                    if ($util.Long)
                        (message.bag[keys[i]] = $util.Long.fromValue(object.bag[keys[i]])).unsigned = false;
                    else if (typeof object.bag[keys[i]] === "string")
                        message.bag[keys[i]] = parseInt(object.bag[keys[i]], 10);
                    else if (typeof object.bag[keys[i]] === "number")
                        message.bag[keys[i]] = object.bag[keys[i]];
                    else if (typeof object.bag[keys[i]] === "object")
                        message.bag[keys[i]] = new $util.LongBits(object.bag[keys[i]].low >>> 0, object.bag[keys[i]].high >>> 0).toNumber();
            }
            if (object.game != null)
        ...
        /**
         * Creates a plain object from a LoginSuccessAck message. Also converts values to other types if specified.
         * @function toObject
         * @memberof protocol.LoginSuccessAck
         * @static
         * @param {protocol.LoginSuccessAck} message LoginSuccessAck
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        LoginSuccessAck.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.objects || options.defaults)
            ...
            if (options.defaults) {
                ...
                if ($util.Long) {
                    ...
                    object.agent = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.agent = options.longs === String ? "0" : 0;
                object.icon = 0;
                object.sex = 0;
                object.vip = 0;
                object.act = "";
            ...
            if (message.id != null && message.hasOwnProperty("id"))
                object.id = message.id;
            if (message.agent != null && message.hasOwnProperty("agent"))
                if (typeof message.agent === "number")
                    object.agent = options.longs === String ? String(message.agent) : message.agent;
                else
                    object.agent = options.longs === String ? $util.Long.prototype.toString.call(message.agent) : options.longs === Number ? new $util.LongBits(message.agent.low >>> 0, message.agent.high >>> 0).toNumber() : message.agent;
            if (message.icon != null && message.hasOwnProperty("icon"))
            ...
            if (message.bag && (keys2 = Object.keys(message.bag)).length) {
                object.bag = {};
                for (var j = 0; j < keys2.length; ++j)
                    if (typeof message.bag[keys2[j]] === "number")
                        object.bag[keys2[j]] = options.longs === String ? String(message.bag[keys2[j]]) : message.bag[keys2[j]];
                    else
                        object.bag[keys2[j]] = options.longs === String ? $util.Long.prototype.toString.call(message.bag[keys2[j]]) : options.longs === Number ? new $util.LongBits(message.bag[keys2[j]].low >>> 0, message.bag[keys2[j]].high >>> 0).toNumber() : message.bag[keys2[j]];
            }
            if (message.game != null && message.hasOwnProperty("game"))
        ...
        /**
         * Converts this LoginSuccessAck to JSON.
         * @function toJSON
         * @memberof protocol.LoginSuccessAck
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        LoginSuccessAck.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        return LoginSuccessAck;
    })();

    protocol.LoginFailAck = (function() {

        /**
         * Properties of a LoginFailAck.
         * @memberof protocol
         * @interface ILoginFailAck
         * @property {number|null} [code] LoginFailAck code
         * @property {string|null} [msg] LoginFailAck msg
         */

        /**
         * Constructs a new LoginFailAck.
         * @memberof protocol
         * @classdesc Represents a LoginFailAck.
         * @implements ILoginFailAck
         * @constructor
         * @param {protocol.ILoginFailAck=} [properties] Properties to set
         */
        function LoginFailAck(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * LoginFailAck code.
         * @member {number} code
         * @memberof protocol.LoginFailAck
         * @instance
         */
        LoginFailAck.prototype.code = 0;
         ...
         * @instance
         */
        LoginFailAck.prototype.msg = "";

        /**
         * Creates a new LoginFailAck instance using the specified properties.
         * @function create
         * @memberof protocol.LoginFailAck
         * @static
         * @param {protocol.ILoginFailAck=} [properties] Properties to set
         * @returns {protocol.LoginFailAck} LoginFailAck instance
         */
        LoginFailAck.create = function create(properties) {
            return new LoginFailAck(properties);
        };

        /**
         * Encodes the specified LoginFailAck message. Does not implicitly {@link protocol.LoginFailAck.verify|verify} messages.
         * @function encode
         * @memberof protocol.LoginFailAck
         * @static
         * @param {protocol.ILoginFailAck} message LoginFailAck message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        LoginFailAck.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.code != null && message.hasOwnProperty("code"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.code);
        ...
        /**
         * Encodes the specified LoginFailAck message, length delimited. Does not implicitly {@link protocol.LoginFailAck.verify|verify} messages.
         * @function encodeDelimited
         * @memberof protocol.LoginFailAck
         * @static
         * @param {protocol.ILoginFailAck} message LoginFailAck message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        LoginFailAck.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a LoginFailAck message from the specified reader or buffer.
         * @function decode
         * @memberof protocol.LoginFailAck
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {protocol.LoginFailAck} LoginFailAck
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        LoginFailAck.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.LoginFailAck();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a LoginFailAck message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof protocol.LoginFailAck
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        LoginFailAck.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a LoginFailAck message.
         * @function verify
         * @memberof protocol.LoginFailAck
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        LoginFailAck.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.code != null && message.hasOwnProperty("code"))
                if (!$util.isInteger(message.code))
        ...
        /**
         * Creates a LoginFailAck message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof protocol.LoginFailAck
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {protocol.LoginFailAck} LoginFailAck
         */
        LoginFailAck.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.LoginFailAck)
                return object;
            var message = new $root.protocol.LoginFailAck();
            if (object.code != null)
                message.code = object.code | 0;
            if (object.msg != null)
                message.msg = String(object.msg);
        ...
        /**
         * Creates a plain object from a LoginFailAck message. Also converts values to other types if specified.
         * @function toObject
         * @memberof protocol.LoginFailAck
         * @static
         * @param {protocol.LoginFailAck} message LoginFailAck
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        LoginFailAck.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
        ...
        /**
         * Converts this LoginFailAck to JSON.
         * @function toJSON
         * @memberof protocol.LoginFailAck
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        LoginFailAck.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    protocol.RoomInfo = (function() {
         ...
         * @property {number|null} [game] RoomInfo game
         * @property {number|null} [level] RoomInfo level
         * @property {number|null} [cap] RoomInfo cap
         * @property {number|null} [ante] RoomInfo ante
         * @property {number|null} [doorMin] RoomInfo doorMin
         * @property {number|null} [doorMax] RoomInfo doorMax
         * @property {number|null} [stayMin] RoomInfo stayMin
         * @property {number|null} [stayMax] RoomInfo stayMax
         * @property {number|null} [playMin] RoomInfo playMin
         * @property {number|null} [playMax] RoomInfo playMax
         * @property {string|null} [coinKey] RoomInfo coinKey
         * @property {number|null} [icon] RoomInfo icon
         ...
         * @constructor
         * @param {protocol.IRoomInfo=} [properties] Properties to set
         */
         ...
         * @instance
         */
        RoomInfo.prototype.ante = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * RoomInfo doorMin.
         * @member {number} doorMin
         * @memberof protocol.RoomInfo
         * @instance
         */
        RoomInfo.prototype.doorMin = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * RoomInfo doorMax.
         * @member {number} doorMax
         * @memberof protocol.RoomInfo
         * @instance
         */
        RoomInfo.prototype.doorMax = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * RoomInfo stayMin.
         * @member {number} stayMin
         * @memberof protocol.RoomInfo
         * @instance
         */
        RoomInfo.prototype.stayMin = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * RoomInfo stayMax.
         * @member {number} stayMax
         * @memberof protocol.RoomInfo
         * @instance
         */
        RoomInfo.prototype.stayMax = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * RoomInfo playMin.
         * @member {number} playMin
         * @memberof protocol.RoomInfo
         * @instance
         */
        RoomInfo.prototype.playMin = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * RoomInfo playMax.
         * @member {number} playMax
         * @memberof protocol.RoomInfo
         * @instance
         */
        RoomInfo.prototype.playMax = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * RoomInfo coinKey.
         * @member {string} coinKey
         * @memberof protocol.RoomInfo
         * @instance
         */
        RoomInfo.prototype.coinKey = "";
         ...
         * @static
         * @param {protocol.IRoomInfo=} [properties] Properties to set
         * @returns {protocol.RoomInfo} RoomInfo instance
         */
        ...
        /**
         * Encodes the specified RoomInfo message. Does not implicitly {@link protocol.RoomInfo.verify|verify} messages.
         * @function encode
         * @memberof protocol.RoomInfo
         * @static
         * @param {protocol.IRoomInfo} message RoomInfo message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        RoomInfo.encode = function encode(message, writer) {
            ...
            if (message.cap != null && message.hasOwnProperty("cap"))
                writer.uint32(/* id 5, wireType 0 =*/40).int32(message.cap);
            if (message.ante != null && message.hasOwnProperty("ante"))
                writer.uint32(/* id 6, wireType 0 =*/48).int64(message.ante);
            if (message.doorMin != null && message.hasOwnProperty("doorMin"))
                writer.uint32(/* id 7, wireType 0 =*/56).int64(message.doorMin);
            if (message.doorMax != null && message.hasOwnProperty("doorMax"))
                writer.uint32(/* id 8, wireType 0 =*/64).int64(message.doorMax);
            if (message.stayMin != null && message.hasOwnProperty("stayMin"))
                writer.uint32(/* id 9, wireType 0 =*/72).int64(message.stayMin);
            if (message.stayMax != null && message.hasOwnProperty("stayMax"))
                writer.uint32(/* id 10, wireType 0 =*/80).int64(message.stayMax);
            if (message.playMin != null && message.hasOwnProperty("playMin"))
                writer.uint32(/* id 11, wireType 0 =*/88).int64(message.playMin);
            if (message.playMax != null && message.hasOwnProperty("playMax"))
                writer.uint32(/* id 12, wireType 0 =*/96).int64(message.playMax);
            if (message.coinKey != null && message.hasOwnProperty("coinKey"))
                writer.uint32(/* id 13, wireType 2 =*/106).string(message.coinKey);
            if (message.icon != null && message.hasOwnProperty("icon"))
                writer.uint32(/* id 14, wireType 0 =*/112).int32(message.icon);
            if (message.online != null && message.hasOwnProperty("online"))
                writer.uint32(/* id 15, wireType 0 =*/120).int32(message.online);
            return writer;
        };

        /**
         * Encodes the specified RoomInfo message, length delimited. Does not implicitly {@link protocol.RoomInfo.verify|verify} messages.
         * @function encodeDelimited
         * @memberof protocol.RoomInfo
         * @static
         * @param {protocol.IRoomInfo} message RoomInfo message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {protocol.RoomInfo} RoomInfo
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        RoomInfo.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.RoomInfo();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                ...
                case 5:
                    ...
                    break;
                case 6:
                    message.ante = reader.int64();
                    break;
                case 7:
                    message.doorMin = reader.int64();
                    break;
                case 8:
                    message.doorMax = reader.int64();
                    break;
                case 9:
                    message.stayMin = reader.int64();
                    break;
                case 10:
                    message.stayMax = reader.int64();
                    break;
                case 11:
                    message.playMin = reader.int64();
                    break;
                case 12:
                    message.playMax = reader.int64();
                    break;
                case 13:
                    message.coinKey = reader.string();
                    break;
                case 14:
                    message.icon = reader.int32();
                    break;
        ...
        RoomInfo.verify = function verify(message) {
            ...
            if (message.ante != null && message.hasOwnProperty("ante"))
                if (!$util.isInteger(message.ante) && !(message.ante && $util.isInteger(message.ante.low) && $util.isInteger(message.ante.high)))
                    return "ante: integer|Long expected";
            if (message.doorMin != null && message.hasOwnProperty("doorMin"))
                if (!$util.isInteger(message.doorMin) && !(message.doorMin && $util.isInteger(message.doorMin.low) && $util.isInteger(message.doorMin.high)))
                    return "doorMin: integer|Long expected";
            if (message.doorMax != null && message.hasOwnProperty("doorMax"))
                if (!$util.isInteger(message.doorMax) && !(message.doorMax && $util.isInteger(message.doorMax.low) && $util.isInteger(message.doorMax.high)))
                    return "doorMax: integer|Long expected";
            if (message.stayMin != null && message.hasOwnProperty("stayMin"))
                if (!$util.isInteger(message.stayMin) && !(message.stayMin && $util.isInteger(message.stayMin.low) && $util.isInteger(message.stayMin.high)))
                    return "stayMin: integer|Long expected";
            if (message.stayMax != null && message.hasOwnProperty("stayMax"))
                if (!$util.isInteger(message.stayMax) && !(message.stayMax && $util.isInteger(message.stayMax.low) && $util.isInteger(message.stayMax.high)))
                    return "stayMax: integer|Long expected";
            if (message.playMin != null && message.hasOwnProperty("playMin"))
                if (!$util.isInteger(message.playMin) && !(message.playMin && $util.isInteger(message.playMin.low) && $util.isInteger(message.playMin.high)))
                    return "playMin: integer|Long expected";
            if (message.playMax != null && message.hasOwnProperty("playMax"))
                if (!$util.isInteger(message.playMax) && !(message.playMax && $util.isInteger(message.playMax.low) && $util.isInteger(message.playMax.high)))
                    return "playMax: integer|Long expected";
            if (message.coinKey != null && message.hasOwnProperty("coinKey"))
                if (!$util.isString(message.coinKey))
                    return "coinKey: string expected";
            if (message.icon != null && message.hasOwnProperty("icon"))
                if (!$util.isInteger(message.icon))
                    return "icon: integer expected";
            if (message.online != null && message.hasOwnProperty("online"))
        ...
        RoomInfo.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.RoomInfo)
                return object;
            var message = new $root.protocol.RoomInfo();
            if (object.name != null)
                message.name = String(object.name);
            if (object.id != null)
                message.id = object.id | 0;
            ...
            if (object.ante != null)
                if ($util.Long)
                    (message.ante = $util.Long.fromValue(object.ante)).unsigned = false;
                else if (typeof object.ante === "string")
                    message.ante = parseInt(object.ante, 10);
                else if (typeof object.ante === "number")
                    message.ante = object.ante;
                else if (typeof object.ante === "object")
                    message.ante = new $util.LongBits(object.ante.low >>> 0, object.ante.high >>> 0).toNumber();
            if (object.doorMin != null)
                if ($util.Long)
                    (message.doorMin = $util.Long.fromValue(object.doorMin)).unsigned = false;
                else if (typeof object.doorMin === "string")
                    message.doorMin = parseInt(object.doorMin, 10);
                else if (typeof object.doorMin === "number")
                    message.doorMin = object.doorMin;
                else if (typeof object.doorMin === "object")
                    message.doorMin = new $util.LongBits(object.doorMin.low >>> 0, object.doorMin.high >>> 0).toNumber();
            if (object.doorMax != null)
                if ($util.Long)
                    (message.doorMax = $util.Long.fromValue(object.doorMax)).unsigned = false;
                else if (typeof object.doorMax === "string")
                    message.doorMax = parseInt(object.doorMax, 10);
                else if (typeof object.doorMax === "number")
                    message.doorMax = object.doorMax;
                else if (typeof object.doorMax === "object")
                    message.doorMax = new $util.LongBits(object.doorMax.low >>> 0, object.doorMax.high >>> 0).toNumber();
            if (object.stayMin != null)
                if ($util.Long)
                    (message.stayMin = $util.Long.fromValue(object.stayMin)).unsigned = false;
                else if (typeof object.stayMin === "string")
                    message.stayMin = parseInt(object.stayMin, 10);
                else if (typeof object.stayMin === "number")
                    message.stayMin = object.stayMin;
                else if (typeof object.stayMin === "object")
                    message.stayMin = new $util.LongBits(object.stayMin.low >>> 0, object.stayMin.high >>> 0).toNumber();
            if (object.stayMax != null)
                if ($util.Long)
                    (message.stayMax = $util.Long.fromValue(object.stayMax)).unsigned = false;
                else if (typeof object.stayMax === "string")
                    message.stayMax = parseInt(object.stayMax, 10);
                else if (typeof object.stayMax === "number")
                    message.stayMax = object.stayMax;
                else if (typeof object.stayMax === "object")
                    message.stayMax = new $util.LongBits(object.stayMax.low >>> 0, object.stayMax.high >>> 0).toNumber();
            if (object.playMin != null)
                if ($util.Long)
                    (message.playMin = $util.Long.fromValue(object.playMin)).unsigned = false;
                else if (typeof object.playMin === "string")
                    message.playMin = parseInt(object.playMin, 10);
                else if (typeof object.playMin === "number")
                    message.playMin = object.playMin;
                else if (typeof object.playMin === "object")
                    message.playMin = new $util.LongBits(object.playMin.low >>> 0, object.playMin.high >>> 0).toNumber();
            if (object.playMax != null)
                if ($util.Long)
                    (message.playMax = $util.Long.fromValue(object.playMax)).unsigned = false;
                else if (typeof object.playMax === "string")
                    message.playMax = parseInt(object.playMax, 10);
                else if (typeof object.playMax === "number")
                    message.playMax = object.playMax;
                else if (typeof object.playMax === "object")
                    message.playMax = new $util.LongBits(object.playMax.low >>> 0, object.playMax.high >>> 0).toNumber();
            if (object.coinKey != null)
                message.coinKey = String(object.coinKey);
            if (object.icon != null)
                message.icon = object.icon | 0;
         ...
         * @memberof protocol.RoomInfo
         * @static
         * @param {protocol.RoomInfo} message RoomInfo
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        RoomInfo.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                if ($util.Long) {
                    var long = new $util.Long(0, 0, false);
                    object.ante = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.ante = options.longs === String ? "0" : 0;
                if ($util.Long) {
                    var long = new $util.Long(0, 0, false);
                    object.doorMin = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.doorMin = options.longs === String ? "0" : 0;
                if ($util.Long) {
                    var long = new $util.Long(0, 0, false);
                    object.doorMax = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.doorMax = options.longs === String ? "0" : 0;
                if ($util.Long) {
                    var long = new $util.Long(0, 0, false);
                    object.stayMin = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.stayMin = options.longs === String ? "0" : 0;
                if ($util.Long) {
                    var long = new $util.Long(0, 0, false);
                    object.stayMax = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.stayMax = options.longs === String ? "0" : 0;
                if ($util.Long) {
                    var long = new $util.Long(0, 0, false);
                    object.playMin = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.playMin = options.longs === String ? "0" : 0;
                if ($util.Long) {
                    var long = new $util.Long(0, 0, false);
                    object.playMax = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.playMax = options.longs === String ? "0" : 0;
                object.coinKey = "";
                object.icon = 0;
                object.online = 0;
            }
            ...
            if (message.ante != null && message.hasOwnProperty("ante"))
                if (typeof message.ante === "number")
                    object.ante = options.longs === String ? String(message.ante) : message.ante;
                else
                    object.ante = options.longs === String ? $util.Long.prototype.toString.call(message.ante) : options.longs === Number ? new $util.LongBits(message.ante.low >>> 0, message.ante.high >>> 0).toNumber() : message.ante;
            if (message.doorMin != null && message.hasOwnProperty("doorMin"))
                if (typeof message.doorMin === "number")
                    object.doorMin = options.longs === String ? String(message.doorMin) : message.doorMin;
                else
                    object.doorMin = options.longs === String ? $util.Long.prototype.toString.call(message.doorMin) : options.longs === Number ? new $util.LongBits(message.doorMin.low >>> 0, message.doorMin.high >>> 0).toNumber() : message.doorMin;
            if (message.doorMax != null && message.hasOwnProperty("doorMax"))
                if (typeof message.doorMax === "number")
                    object.doorMax = options.longs === String ? String(message.doorMax) : message.doorMax;
                else
                    object.doorMax = options.longs === String ? $util.Long.prototype.toString.call(message.doorMax) : options.longs === Number ? new $util.LongBits(message.doorMax.low >>> 0, message.doorMax.high >>> 0).toNumber() : message.doorMax;
            if (message.stayMin != null && message.hasOwnProperty("stayMin"))
                if (typeof message.stayMin === "number")
                    object.stayMin = options.longs === String ? String(message.stayMin) : message.stayMin;
                else
                    object.stayMin = options.longs === String ? $util.Long.prototype.toString.call(message.stayMin) : options.longs === Number ? new $util.LongBits(message.stayMin.low >>> 0, message.stayMin.high >>> 0).toNumber() : message.stayMin;
            if (message.stayMax != null && message.hasOwnProperty("stayMax"))
                if (typeof message.stayMax === "number")
                    object.stayMax = options.longs === String ? String(message.stayMax) : message.stayMax;
                else
                    object.stayMax = options.longs === String ? $util.Long.prototype.toString.call(message.stayMax) : options.longs === Number ? new $util.LongBits(message.stayMax.low >>> 0, message.stayMax.high >>> 0).toNumber() : message.stayMax;
            if (message.playMin != null && message.hasOwnProperty("playMin"))
                if (typeof message.playMin === "number")
                    object.playMin = options.longs === String ? String(message.playMin) : message.playMin;
                else
                    object.playMin = options.longs === String ? $util.Long.prototype.toString.call(message.playMin) : options.longs === Number ? new $util.LongBits(message.playMin.low >>> 0, message.playMin.high >>> 0).toNumber() : message.playMin;
            if (message.playMax != null && message.hasOwnProperty("playMax"))
                if (typeof message.playMax === "number")
                    object.playMax = options.longs === String ? String(message.playMax) : message.playMax;
                else
                    object.playMax = options.longs === String ? $util.Long.prototype.toString.call(message.playMax) : options.longs === Number ? new $util.LongBits(message.playMax.low >>> 0, message.playMax.high >>> 0).toNumber() : message.playMax;
            if (message.coinKey != null && message.hasOwnProperty("coinKey"))
                object.coinKey = message.coinKey;
            if (message.icon != null && message.hasOwnProperty("icon"))
                object.icon = message.icon;
            if (message.online != null && message.hasOwnProperty("online"))
    ...
    protocol.GameKindReq = (function() {

        /**
         * Properties of a GameKindReq.
         * @memberof protocol
         * @interface IGameKindReq
         * @property {number|null} [game] GameKindReq game
         */

        /**
         * Constructs a new GameKindReq.
         * @memberof protocol
         * @classdesc Represents a GameKindReq.
         * @implements IGameKindReq
         * @constructor
         * @param {protocol.IGameKindReq=} [properties] Properties to set
         */
        function GameKindReq(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * GameKindReq game.
         * @member {number} game
         * @memberof protocol.GameKindReq
         * @instance
         */
        GameKindReq.prototype.game = 0;

        /**
         * Creates a new GameKindReq instance using the specified properties.
         * @function create
         * @memberof protocol.GameKindReq
         * @static
         * @param {protocol.IGameKindReq=} [properties] Properties to set
         * @returns {protocol.GameKindReq} GameKindReq instance
         */
        GameKindReq.create = function create(properties) {
            return new GameKindReq(properties);
        };

        /**
         * Encodes the specified GameKindReq message. Does not implicitly {@link protocol.GameKindReq.verify|verify} messages.
         * @function encode
         * @memberof protocol.GameKindReq
         * @static
         * @param {protocol.IGameKindReq} message GameKindReq message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        GameKindReq.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.game != null && message.hasOwnProperty("game"))
        ...
        /**
         * Encodes the specified GameKindReq message, length delimited. Does not implicitly {@link protocol.GameKindReq.verify|verify} messages.
         * @function encodeDelimited
         * @memberof protocol.GameKindReq
         * @static
         * @param {protocol.IGameKindReq} message GameKindReq message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        GameKindReq.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a GameKindReq message from the specified reader or buffer.
         * @function decode
         * @memberof protocol.GameKindReq
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {protocol.GameKindReq} GameKindReq
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        GameKindReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.GameKindReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a GameKindReq message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof protocol.GameKindReq
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        GameKindReq.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a GameKindReq message.
         * @function verify
         * @memberof protocol.GameKindReq
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        GameKindReq.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.game != null && message.hasOwnProperty("game"))
                if (!$util.isInteger(message.game))
        ...
        /**
         * Creates a GameKindReq message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof protocol.GameKindReq
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {protocol.GameKindReq} GameKindReq
         */
        GameKindReq.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.GameKindReq)
                return object;
            var message = new $root.protocol.GameKindReq();
            if (object.game != null)
                message.game = object.game | 0;
            return message;
        };
        ...
        /**
         * Creates a plain object from a GameKindReq message. Also converts values to other types if specified.
         * @function toObject
         * @memberof protocol.GameKindReq
         * @static
         * @param {protocol.GameKindReq} message GameKindReq
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        GameKindReq.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults)
        ...
        /**
         * Converts this GameKindReq to JSON.
         * @function toJSON
         * @memberof protocol.GameKindReq
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        GameKindReq.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    protocol.GameKindAck = (function() {

        /**
         * Properties of a GameKindAck.
         * @memberof protocol
         * @interface IGameKindAck
         * @property {Array.<protocol.IRoomInfo>|null} [rooms] GameKindAck rooms
         */

        /**
         * Constructs a new GameKindAck.
         * @memberof protocol
         * @classdesc Represents a GameKindAck.
         * @implements IGameKindAck
         * @constructor
         * @param {protocol.IGameKindAck=} [properties] Properties to set
         */
        function GameKindAck(properties) {
            this.rooms = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
        ...
        /**
         * GameKindAck rooms.
         * @member {Array.<protocol.IRoomInfo>} rooms
         * @memberof protocol.GameKindAck
         * @instance
         */
        GameKindAck.prototype.rooms = $util.emptyArray;

        /**
         * Creates a new GameKindAck instance using the specified properties.
         * @function create
         * @memberof protocol.GameKindAck
         * @static
         * @param {protocol.IGameKindAck=} [properties] Properties to set
         * @returns {protocol.GameKindAck} GameKindAck instance
         */
        GameKindAck.create = function create(properties) {
            return new GameKindAck(properties);
        };

        /**
         * Encodes the specified GameKindAck message. Does not implicitly {@link protocol.GameKindAck.verify|verify} messages.
         * @function encode
         * @memberof protocol.GameKindAck
         * @static
         * @param {protocol.IGameKindAck} message GameKindAck message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        GameKindAck.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.rooms != null && message.rooms.length)
                for (var i = 0; i < message.rooms.length; ++i)
                    $root.protocol.RoomInfo.encode(message.rooms[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            return writer;
        };

        /**
         * Encodes the specified GameKindAck message, length delimited. Does not implicitly {@link protocol.GameKindAck.verify|verify} messages.
         * @function encodeDelimited
         * @memberof protocol.GameKindAck
         * @static
         * @param {protocol.IGameKindAck} message GameKindAck message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        GameKindAck.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a GameKindAck message from the specified reader or buffer.
         * @function decode
         * @memberof protocol.GameKindAck
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {protocol.GameKindAck} GameKindAck
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        GameKindAck.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.GameKindAck();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    if (!(message.rooms && message.rooms.length))
                        message.rooms = [];
                    message.rooms.push($root.protocol.RoomInfo.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        /**
         * Decodes a GameKindAck message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof protocol.GameKindAck
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        GameKindAck.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a GameKindAck message.
         * @function verify
         * @memberof protocol.GameKindAck
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        GameKindAck.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.rooms != null && message.hasOwnProperty("rooms")) {
                ...
                for (var i = 0; i < message.rooms.length; ++i) {
                    var error = $root.protocol.RoomInfo.verify(message.rooms[i]);
                    if (error)
                        return "rooms." + error;
                }
            }
        ...
        /**
         * Creates a GameKindAck message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof protocol.GameKindAck
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {protocol.GameKindAck} GameKindAck
         */
        GameKindAck.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.GameKindAck)
                return object;
            var message = new $root.protocol.GameKindAck();
            if (object.rooms) {
                if (!Array.isArray(object.rooms))
                    throw TypeError(".protocol.GameKindAck.rooms: array expected");
                message.rooms = [];
                for (var i = 0; i < object.rooms.length; ++i) {
                    if (typeof object.rooms[i] !== "object")
                        throw TypeError(".protocol.GameKindAck.rooms: object expected");
                    message.rooms[i] = $root.protocol.RoomInfo.fromObject(object.rooms[i]);
                }
            }
            return message;
        };
        ...
        /**
         * Creates a plain object from a GameKindAck message. Also converts values to other types if specified.
         * @function toObject
         * @memberof protocol.GameKindAck
         * @static
         * @param {protocol.GameKindAck} message GameKindAck
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        GameKindAck.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.arrays || options.defaults)
            ...
            if (message.rooms && message.rooms.length) {
                ...
                for (var j = 0; j < message.rooms.length; ++j)
                    object.rooms[j] = $root.protocol.RoomInfo.toObject(message.rooms[j], options);
            }
            return object;
        };

        /**
         * Converts this GameKindAck to JSON.
         * @function toJSON
         * @memberof protocol.GameKindAck
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        GameKindAck.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    protocol.LoginGameReq = (function() {

        /**
         * Properties of a LoginGameReq.
         * @memberof protocol
         * @interface ILoginGameReq
         * @property {number|null} [game] LoginGameReq game
         * @property {number|null} [level] LoginGameReq level
         * @property {number|null} [room] LoginGameReq room
         * @property {string|null} [args] LoginGameReq args
         */

        /**
         * Constructs a new LoginGameReq.
         * @memberof protocol
         * @classdesc Represents a LoginGameReq.
         * @implements ILoginGameReq
         * @constructor
         * @param {protocol.ILoginGameReq=} [properties] Properties to set
         */
        function LoginGameReq(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * LoginGameReq game.
         * @member {number} game
         * @memberof protocol.LoginGameReq
         * @instance
         */
        LoginGameReq.prototype.game = 0;
         ...
         * @instance
         */
        LoginGameReq.prototype.level = 0;
         ...
         * @instance
         */
        LoginGameReq.prototype.args = "";

        /**
         * Creates a new LoginGameReq instance using the specified properties.
         * @function create
         * @memberof protocol.LoginGameReq
         * @static
         * @param {protocol.ILoginGameReq=} [properties] Properties to set
         * @returns {protocol.LoginGameReq} LoginGameReq instance
         */
        LoginGameReq.create = function create(properties) {
            return new LoginGameReq(properties);
        };

        /**
         * Encodes the specified LoginGameReq message. Does not implicitly {@link protocol.LoginGameReq.verify|verify} messages.
         * @function encode
         * @memberof protocol.LoginGameReq
         * @static
         * @param {protocol.ILoginGameReq} message LoginGameReq message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        LoginGameReq.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.game != null && message.hasOwnProperty("game"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.game);
            ...
            if (message.room != null && message.hasOwnProperty("room"))
                writer.uint32(/* id 3, wireType 0 =*/24).int32(message.room);
        ...
        /**
         * Encodes the specified LoginGameReq message, length delimited. Does not implicitly {@link protocol.LoginGameReq.verify|verify} messages.
         * @function encodeDelimited
         * @memberof protocol.LoginGameReq
         * @static
         * @param {protocol.ILoginGameReq} message LoginGameReq message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        LoginGameReq.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a LoginGameReq message from the specified reader or buffer.
         * @function decode
         * @memberof protocol.LoginGameReq
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {protocol.LoginGameReq} LoginGameReq
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        LoginGameReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.LoginGameReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a LoginGameReq message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof protocol.LoginGameReq
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        LoginGameReq.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a LoginGameReq message.
         * @function verify
         * @memberof protocol.LoginGameReq
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        LoginGameReq.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.game != null && message.hasOwnProperty("game"))
                if (!$util.isInteger(message.game))
        ...
        /**
         * Creates a LoginGameReq message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof protocol.LoginGameReq
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {protocol.LoginGameReq} LoginGameReq
         */
        LoginGameReq.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.LoginGameReq)
                return object;
            var message = new $root.protocol.LoginGameReq();
            if (object.game != null)
                message.game = object.game | 0;
            if (object.level != null)
                message.level = object.level | 0;
        ...
        /**
         * Creates a plain object from a LoginGameReq message. Also converts values to other types if specified.
         * @function toObject
         * @memberof protocol.LoginGameReq
         * @static
         * @param {protocol.LoginGameReq} message LoginGameReq
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        LoginGameReq.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
        ...
        /**
         * Converts this LoginGameReq to JSON.
         * @function toJSON
         * @memberof protocol.LoginGameReq
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        LoginGameReq.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    protocol.LoginGameAck = (function() {

        /**
         * Properties of a LoginGameAck.
         * @memberof protocol
         * @interface ILoginGameAck
         * @property {number|null} [game] LoginGameAck game
         * @property {number|null} [room] LoginGameAck room
         * @property {number|null} [code] LoginGameAck code
         * @property {string|null} [msg] LoginGameAck msg
         */

        /**
         * Constructs a new LoginGameAck.
         * @memberof protocol
         * @classdesc Represents a LoginGameAck.
         * @implements ILoginGameAck
         * @constructor
         * @param {protocol.ILoginGameAck=} [properties] Properties to set
         */
        function LoginGameAck(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * LoginGameAck game.
         * @member {number} game
         * @memberof protocol.LoginGameAck
         * @instance
         */
        LoginGameAck.prototype.game = 0;
         ...
         * @instance
         */
        LoginGameAck.prototype.msg = "";

        /**
         * Creates a new LoginGameAck instance using the specified properties.
         * @function create
         * @memberof protocol.LoginGameAck
         * @static
         * @param {protocol.ILoginGameAck=} [properties] Properties to set
         * @returns {protocol.LoginGameAck} LoginGameAck instance
         */
        LoginGameAck.create = function create(properties) {
            return new LoginGameAck(properties);
        };

        /**
         * Encodes the specified LoginGameAck message. Does not implicitly {@link protocol.LoginGameAck.verify|verify} messages.
         * @function encode
         * @memberof protocol.LoginGameAck
         * @static
         * @param {protocol.ILoginGameAck} message LoginGameAck message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        LoginGameAck.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.game != null && message.hasOwnProperty("game"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.game);
        ...
        /**
         * Encodes the specified LoginGameAck message, length delimited. Does not implicitly {@link protocol.LoginGameAck.verify|verify} messages.
         * @function encodeDelimited
         * @memberof protocol.LoginGameAck
         * @static
         * @param {protocol.ILoginGameAck} message LoginGameAck message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        LoginGameAck.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a LoginGameAck message from the specified reader or buffer.
         * @function decode
         * @memberof protocol.LoginGameAck
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {protocol.LoginGameAck} LoginGameAck
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        LoginGameAck.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.LoginGameAck();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a LoginGameAck message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof protocol.LoginGameAck
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        LoginGameAck.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a LoginGameAck message.
         * @function verify
         * @memberof protocol.LoginGameAck
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        LoginGameAck.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.game != null && message.hasOwnProperty("game"))
                if (!$util.isInteger(message.game))
        ...
        /**
         * Creates a LoginGameAck message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof protocol.LoginGameAck
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {protocol.LoginGameAck} LoginGameAck
         */
        LoginGameAck.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.LoginGameAck)
                return object;
            var message = new $root.protocol.LoginGameAck();
            if (object.game != null)
                message.game = object.game | 0;
            if (object.room != null)
                message.room = object.room | 0;
        ...
        /**
         * Creates a plain object from a LoginGameAck message. Also converts values to other types if specified.
         * @function toObject
         * @memberof protocol.LoginGameAck
         * @static
         * @param {protocol.LoginGameAck} message LoginGameAck
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        LoginGameAck.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
        ...
        /**
         * Converts this LoginGameAck to JSON.
         * @function toJSON
         * @memberof protocol.LoginGameAck
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        LoginGameAck.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    protocol.SendGameFail = (function() {

        /**
         * Properties of a SendGameFail.
         * @memberof protocol
         * @interface ISendGameFail
         * @property {number|null} [code] SendGameFail code
         * @property {string|null} [msg] SendGameFail msg
         * @property {number|null} [game] SendGameFail game
         * @property {number|null} [room] SendGameFail room
         */

        /**
         * Constructs a new SendGameFail.
         * @memberof protocol
         * @classdesc Represents a SendGameFail.
         * @implements ISendGameFail
         * @constructor
         * @param {protocol.ISendGameFail=} [properties] Properties to set
         */
        function SendGameFail(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * SendGameFail code.
         * @member {number} code
         * @memberof protocol.SendGameFail
         * @instance
         */
        SendGameFail.prototype.code = 0;
         ...
         * @instance
         */
        SendGameFail.prototype.room = 0;

        /**
         * Creates a new SendGameFail instance using the specified properties.
         * @function create
         * @memberof protocol.SendGameFail
         * @static
         * @param {protocol.ISendGameFail=} [properties] Properties to set
         * @returns {protocol.SendGameFail} SendGameFail instance
         */
        SendGameFail.create = function create(properties) {
            return new SendGameFail(properties);
        };

        /**
         * Encodes the specified SendGameFail message. Does not implicitly {@link protocol.SendGameFail.verify|verify} messages.
         * @function encode
         * @memberof protocol.SendGameFail
         * @static
         * @param {protocol.ISendGameFail} message SendGameFail message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        SendGameFail.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.code != null && message.hasOwnProperty("code"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.code);
            ...
            if (message.game != null && message.hasOwnProperty("game"))
                writer.uint32(/* id 3, wireType 0 =*/24).int32(message.game);
            if (message.room != null && message.hasOwnProperty("room"))
                writer.uint32(/* id 4, wireType 0 =*/32).int32(message.room);
            return writer;
        };

        /**
         * Encodes the specified SendGameFail message, length delimited. Does not implicitly {@link protocol.SendGameFail.verify|verify} messages.
         * @function encodeDelimited
         * @memberof protocol.SendGameFail
         * @static
         * @param {protocol.ISendGameFail} message SendGameFail message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SendGameFail.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a SendGameFail message from the specified reader or buffer.
         * @function decode
         * @memberof protocol.SendGameFail
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {protocol.SendGameFail} SendGameFail
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SendGameFail.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.SendGameFail();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a SendGameFail message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof protocol.SendGameFail
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SendGameFail.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a SendGameFail message.
         * @function verify
         * @memberof protocol.SendGameFail
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SendGameFail.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.code != null && message.hasOwnProperty("code"))
                if (!$util.isInteger(message.code))
        ...
        /**
         * Creates a SendGameFail message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof protocol.SendGameFail
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {protocol.SendGameFail} SendGameFail
         */
        SendGameFail.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.SendGameFail)
                return object;
            var message = new $root.protocol.SendGameFail();
            if (object.code != null)
                message.code = object.code | 0;
            if (object.msg != null)
                message.msg = String(object.msg);
        ...
        /**
         * Creates a plain object from a SendGameFail message. Also converts values to other types if specified.
         * @function toObject
         * @memberof protocol.SendGameFail
         * @static
         * @param {protocol.SendGameFail} message SendGameFail
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        SendGameFail.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
        ...
        /**
         * Converts this SendGameFail to JSON.
         * @function toJSON
         * @memberof protocol.SendGameFail
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        SendGameFail.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    protocol.ExitGameReq = (function() {

        /**
         * Properties of an ExitGameReq.
         * @memberof protocol
         * @interface IExitGameReq
         * @property {number|null} [game] ExitGameReq game
         * @property {number|null} [room] ExitGameReq room
         */

        /**
         * Constructs a new ExitGameReq.
         * @memberof protocol
         * @classdesc Represents an ExitGameReq.
         * @implements IExitGameReq
         * @constructor
         * @param {protocol.IExitGameReq=} [properties] Properties to set
         */
         ...
         * ExitGameReq game.
         * @member {number} game
         * @memberof protocol.ExitGameReq
         * @instance
         */
        ExitGameReq.prototype.game = 0;
         ...
         * @static
         * @param {protocol.IExitGameReq=} [properties] Properties to set
         * @returns {protocol.ExitGameReq} ExitGameReq instance
         */
        ...
        /**
         * Encodes the specified ExitGameReq message. Does not implicitly {@link protocol.ExitGameReq.verify|verify} messages.
         * @function encode
         * @memberof protocol.ExitGameReq
         * @static
         * @param {protocol.IExitGameReq} message ExitGameReq message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified ExitGameReq message, length delimited. Does not implicitly {@link protocol.ExitGameReq.verify|verify} messages.
         * @function encodeDelimited
         * @memberof protocol.ExitGameReq
         * @static
         * @param {protocol.IExitGameReq} message ExitGameReq message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {protocol.ExitGameReq} ExitGameReq
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ExitGameReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.ExitGameReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        ExitGameReq.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.ExitGameReq)
                return object;
            var message = new $root.protocol.ExitGameReq();
            if (object.game != null)
                message.game = object.game | 0;
            if (object.room != null)
                message.room = object.room | 0;
         ...
         * @memberof protocol.ExitGameReq
         * @static
         * @param {protocol.ExitGameReq} message ExitGameReq
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
    ...
    protocol.ExitGameAck = (function() {

        /**
         * Properties of an ExitGameAck.
         * @memberof protocol
         * @interface IExitGameAck
         * @property {number|null} [code] ExitGameAck code
         * @property {string|null} [msg] ExitGameAck msg
         */

        /**
         * Constructs a new ExitGameAck.
         * @memberof protocol
         * @classdesc Represents an ExitGameAck.
         * @implements IExitGameAck
         * @constructor
         * @param {protocol.IExitGameAck=} [properties] Properties to set
         */
        function ExitGameAck(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * ExitGameAck code.
         * @member {number} code
         * @memberof protocol.ExitGameAck
         * @instance
         */
        ExitGameAck.prototype.code = 0;
         ...
         * @instance
         */
        ExitGameAck.prototype.msg = "";

        /**
         * Creates a new ExitGameAck instance using the specified properties.
         * @function create
         * @memberof protocol.ExitGameAck
         * @static
         * @param {protocol.IExitGameAck=} [properties] Properties to set
         * @returns {protocol.ExitGameAck} ExitGameAck instance
         */
        ExitGameAck.create = function create(properties) {
            return new ExitGameAck(properties);
        };

        /**
         * Encodes the specified ExitGameAck message. Does not implicitly {@link protocol.ExitGameAck.verify|verify} messages.
         * @function encode
         * @memberof protocol.ExitGameAck
         * @static
         * @param {protocol.IExitGameAck} message ExitGameAck message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ExitGameAck.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.code != null && message.hasOwnProperty("code"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.code);
        ...
        /**
         * Encodes the specified ExitGameAck message, length delimited. Does not implicitly {@link protocol.ExitGameAck.verify|verify} messages.
         * @function encodeDelimited
         * @memberof protocol.ExitGameAck
         * @static
         * @param {protocol.IExitGameAck} message ExitGameAck message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ExitGameAck.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes an ExitGameAck message from the specified reader or buffer.
         * @function decode
         * @memberof protocol.ExitGameAck
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {protocol.ExitGameAck} ExitGameAck
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ExitGameAck.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.ExitGameAck();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes an ExitGameAck message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof protocol.ExitGameAck
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ExitGameAck.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies an ExitGameAck message.
         * @function verify
         * @memberof protocol.ExitGameAck
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        ExitGameAck.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.code != null && message.hasOwnProperty("code"))
                if (!$util.isInteger(message.code))
        ...
        /**
         * Creates an ExitGameAck message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof protocol.ExitGameAck
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {protocol.ExitGameAck} ExitGameAck
         */
        ExitGameAck.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.ExitGameAck)
                return object;
            var message = new $root.protocol.ExitGameAck();
            if (object.code != null)
                message.code = object.code | 0;
            if (object.msg != null)
                message.msg = String(object.msg);
        ...
        /**
         * Creates a plain object from an ExitGameAck message. Also converts values to other types if specified.
         * @function toObject
         * @memberof protocol.ExitGameAck
         * @static
         * @param {protocol.ExitGameAck} message ExitGameAck
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ExitGameAck.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
        ...
        /**
         * Converts this ExitGameAck to JSON.
         * @function toJSON
         * @memberof protocol.ExitGameAck
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        ExitGameAck.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    protocol.MsgId = (function() {
         ...
         * @implements IMsgId
         * @constructor
         * @param {protocol.IMsgId=} [properties] Properties to set
         */
         ...
         * @function create
         * @memberof protocol.MsgId
         * @static
         * @param {protocol.IMsgId=} [properties] Properties to set
         * @returns {protocol.MsgId} MsgId instance
         */
        ...
        /**
         * Encodes the specified MsgId message. Does not implicitly {@link protocol.MsgId.verify|verify} messages.
         * @function encode
         * @memberof protocol.MsgId
         * @static
         * @param {protocol.IMsgId} message MsgId message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified MsgId message, length delimited. Does not implicitly {@link protocol.MsgId.verify|verify} messages.
         * @function encodeDelimited
         * @memberof protocol.MsgId
         * @static
         * @param {protocol.IMsgId} message MsgId message or plain object to encode
        ...
        MsgId.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.MsgId();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                default:
        ...
        MsgId.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.MsgId)
                return object;
            return new $root.protocol.MsgId();
        };
         ...
         * @memberof protocol.MsgId
         * @static
         * @param {protocol.MsgId} message MsgId
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        MsgId.toObject = function toObject() {
            return {};
        };
         ...
         * @property {number} VerCheckAck=105 VerCheckAck value
         * @property {number} RegistReq=107 RegistReq value
         ...
         * @property {number} GameListAck=205 GameListAck value
         * @property {number} CodeUpAccountReq=210 CodeUpAccountReq value
         * @property {number} CodeUpAccountAck=211 CodeUpAccountAck value
         * @property {number} UpdateAccountReq=212 UpdateAccountReq value
         * @property {number} UpdateAccountAck=213 UpdateAccountAck value
         * @property {number} CodeSetPwdReq=214 CodeSetPwdReq value
         * @property {number} CodeSetPwdAck=215 CodeSetPwdAck value
         * @property {number} ChangePwdReq=216 ChangePwdReq value
         * @property {number} ChangePwdAck=217 ChangePwdAck value
         * @property {number} BagGetReq=220 BagGetReq value
         * @property {number} BagGetAck=221 BagGetAck value
         * @property {number} BagMoveReq=222 BagMoveReq value
         * @property {number} BagMoveAck=223 BagMoveAck value
         * @property {number} RepayInfoReq=240 RepayInfoReq value
         * @property {number} RepayInfoAck=241 RepayInfoAck value
         * @property {number} RepaySetAliReq=242 RepaySetAliReq value
         * @property {number} RepaySetAliAck=243 RepaySetAliAck value
         * @property {number} RepaySetBankReq=244 RepaySetBankReq value
         * @property {number} RepaySetBankAck=245 RepaySetBankAck value
         * @property {number} RepayListOrderReq=246 RepayListOrderReq value
         * @property {number} RepayListOrderAck=247 RepayListOrderAck value
         * @property {number} RepayNewOrderReq=248 RepayNewOrderReq value
         * @property {number} RepayNewOrderAck=249 RepayNewOrderAck value
         * @property {number} CustomSendReq=260 CustomSendReq value
         * @property {number} CustomSendAck=261 CustomSendAck value
         * @property {number} CustomRecvReq=262 CustomRecvReq value
         * @property {number} CustomRecvAck=263 CustomRecvAck value
         * @property {number} CustomCommonReq=264 CustomCommonReq value
         * @property {number} CustomCommonAck=265 CustomCommonAck value
         * @property {number} CustomNoteReq=266 CustomNoteReq value
         * @property {number} CustomNoteAck=267 CustomNoteAck value
         * @property {number} RankGetReq=270 RankGetReq value
         * @property {number} RankGetAck=271 RankGetAck value
         * @property {number} LoginGameReq=301 LoginGameReq value
         * @property {number} LoginGameAck=302 LoginGameAck value
         * @property {number} SendGameFail=304 SendGameFail value
         * @property {number} ExitGameReq=305 ExitGameReq value
         * @property {number} ExitGameAck=306 ExitGameAck value
         * @property {number} PayInfoReq=1100 PayInfoReq value
         * @property {number} PayInfoAck=1101 PayInfoAck value
         * @property {number} PayOrderReq=1102 PayOrderReq value
         * @property {number} PayOrderAck=1103 PayOrderAck value
         * @property {number} MailListReq=1110 MailListReq value
         * @property {number} MailListAck=1111 MailListAck value
         * @property {number} MailReadReq=1112 MailReadReq value
         * @property {number} MailReadAck=1113 MailReadAck value
         * @property {number} MailDeleteReq=1114 MailDeleteReq value
         * @property {number} MailDeleteAck=1115 MailDeleteAck value
         * @property {number} SpreadGetReq=1130 SpreadGetReq value
         * @property {number} SpreadGetAck=1131 SpreadGetAck value
         * @property {number} SpreadSetReq=1132 SpreadSetReq value
         * @property {number} SpreadSetAck=1133 SpreadSetAck value
         * @property {number} SpreadGiftReq=1134 SpreadGiftReq value
         * @property {number} SpreadGiftAck=1135 SpreadGiftAck value
         * @property {number} GameMessageHeadSplit=8192 GameMessageHeadSplit value
         */
        MsgId.Code = (function() {
            ...
            values[valuesById[105] = "VerCheckAck"] = 105;
            values[valuesById[107] = "RegistReq"] = 107;
            ...
            values[valuesById[205] = "GameListAck"] = 205;
            values[valuesById[210] = "CodeUpAccountReq"] = 210;
            values[valuesById[211] = "CodeUpAccountAck"] = 211;
            values[valuesById[212] = "UpdateAccountReq"] = 212;
            values[valuesById[213] = "UpdateAccountAck"] = 213;
            values[valuesById[214] = "CodeSetPwdReq"] = 214;
            values[valuesById[215] = "CodeSetPwdAck"] = 215;
            values[valuesById[216] = "ChangePwdReq"] = 216;
            values[valuesById[217] = "ChangePwdAck"] = 217;
            values[valuesById[220] = "BagGetReq"] = 220;
            values[valuesById[221] = "BagGetAck"] = 221;
            values[valuesById[222] = "BagMoveReq"] = 222;
            values[valuesById[223] = "BagMoveAck"] = 223;
            values[valuesById[240] = "RepayInfoReq"] = 240;
            values[valuesById[241] = "RepayInfoAck"] = 241;
            values[valuesById[242] = "RepaySetAliReq"] = 242;
            values[valuesById[243] = "RepaySetAliAck"] = 243;
            values[valuesById[244] = "RepaySetBankReq"] = 244;
            values[valuesById[245] = "RepaySetBankAck"] = 245;
            values[valuesById[246] = "RepayListOrderReq"] = 246;
            values[valuesById[247] = "RepayListOrderAck"] = 247;
            values[valuesById[248] = "RepayNewOrderReq"] = 248;
            values[valuesById[249] = "RepayNewOrderAck"] = 249;
            values[valuesById[260] = "CustomSendReq"] = 260;
            values[valuesById[261] = "CustomSendAck"] = 261;
            values[valuesById[262] = "CustomRecvReq"] = 262;
            values[valuesById[263] = "CustomRecvAck"] = 263;
            values[valuesById[264] = "CustomCommonReq"] = 264;
            values[valuesById[265] = "CustomCommonAck"] = 265;
            values[valuesById[266] = "CustomNoteReq"] = 266;
            values[valuesById[267] = "CustomNoteAck"] = 267;
            values[valuesById[270] = "RankGetReq"] = 270;
            values[valuesById[271] = "RankGetAck"] = 271;
            values[valuesById[301] = "LoginGameReq"] = 301;
            values[valuesById[302] = "LoginGameAck"] = 302;
            values[valuesById[304] = "SendGameFail"] = 304;
            values[valuesById[305] = "ExitGameReq"] = 305;
            values[valuesById[306] = "ExitGameAck"] = 306;
            values[valuesById[1100] = "PayInfoReq"] = 1100;
            values[valuesById[1101] = "PayInfoAck"] = 1101;
            values[valuesById[1102] = "PayOrderReq"] = 1102;
            values[valuesById[1103] = "PayOrderAck"] = 1103;
            values[valuesById[1110] = "MailListReq"] = 1110;
            values[valuesById[1111] = "MailListAck"] = 1111;
            values[valuesById[1112] = "MailReadReq"] = 1112;
            values[valuesById[1113] = "MailReadAck"] = 1113;
            values[valuesById[1114] = "MailDeleteReq"] = 1114;
            values[valuesById[1115] = "MailDeleteAck"] = 1115;
            values[valuesById[1130] = "SpreadGetReq"] = 1130;
            values[valuesById[1131] = "SpreadGetAck"] = 1131;
            values[valuesById[1132] = "SpreadSetReq"] = 1132;
            values[valuesById[1133] = "SpreadSetAck"] = 1133;
            values[valuesById[1134] = "SpreadGiftReq"] = 1134;
            values[valuesById[1135] = "SpreadGiftAck"] = 1135;
            values[valuesById[8192] = "GameMessageHeadSplit"] = 8192;
            return values;
        })();
    ...
    protocol.Error = (function() {
         ...
         * @implements IError
         * @constructor
         * @param {protocol.IError=} [properties] Properties to set
         */
         ...
         * @function create
         * @memberof protocol.Error
         * @static
         * @param {protocol.IError=} [properties] Properties to set
         * @returns {protocol.Error} Error instance
         */
        ...
        /**
         * Encodes the specified Error message. Does not implicitly {@link protocol.Error.verify|verify} messages.
         * @function encode
         * @memberof protocol.Error
         * @static
         * @param {protocol.IError} message Error message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified Error message, length delimited. Does not implicitly {@link protocol.Error.verify|verify} messages.
         * @function encodeDelimited
         * @memberof protocol.Error
         * @static
         * @param {protocol.IError} message Error message or plain object to encode
        ...
        Error.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.protocol.Error();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                default:
        ...
        Error.fromObject = function fromObject(object) {
            if (object instanceof $root.protocol.Error)
                return object;
            return new $root.protocol.Error();
        };
         ...
         * @memberof protocol.Error
         * @static
         * @param {protocol.Error} message Error
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
         ...
         * @property {number} LoginRepeat=1 LoginRepeat value
         * @property {number} LoginFail=2 LoginFail value
         * @property {number} LoginOther=3 LoginOther value
         * @property {number} CreateUserFail=4 CreateUserFail value
         * @property {number} DatabaseFail=5 DatabaseFail value
         */
        Error.Code = (function() {
            var valuesById = {}, values = Object.create(valuesById);
            values[valuesById[0] = "None"] = 0;
            values["Success"] = 0;
            values["OK"] = 0;
            values[valuesById[1] = "LoginRepeat"] = 1;
            values[valuesById[2] = "LoginFail"] = 2;
            values[valuesById[3] = "LoginOther"] = 3;
            values[valuesById[4] = "CreateUserFail"] = 4;
            values[valuesById[5] = "DatabaseFail"] = 5;
            return values;
        })();
